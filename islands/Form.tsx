    ...
    >
      <div className="p-4 bg-white border border-orange-300 rounded">
              ...
              <div className="mt-2 sm:col-span-2 sm:mt-0">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-yellow-600 sm:max-w-md">
                  ...
                  <input
                    ...
                    id="from"
                    autoComplete="from"
                    className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 focus-visible:outline-none"
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
              ...
              <div className="mt-2 sm:col-span-2 sm:mt-0">
                <textarea
                  ...
                  name="text"
                  rows={3}
                  className="block w-full max-w-2xl rounded-md border-0 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-yellow-600 sm:text-sm sm:leading-6 focus-visible:outline-none"
                  defaultValue={""}
                />
              </div>
            </div>
        ...
        <div className="mt-6 flex items-center justify-end gap-x-6">
          <button
            type="submit"
            className="inline-flex justify-center rounded-md bg-yellow-400 px-3 py-2 text-sm font-semibold text-gray-600 shadow-sm hover:bg-yellow-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-600"
          >
            Post
          </button>
        </div>
