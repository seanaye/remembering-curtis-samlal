            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
              ...
              <div className="mt-2 sm:col-span-2 sm:mt-0">
                <textarea
                  ...
                  name="text"
                  rows={3}
                  className="block w-full max-w-2xl rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-yellow-600 sm:text-sm sm:leading-6 focus-visible:outline-none"
                  defaultValue={""}
                />
              </div>
            </div>
